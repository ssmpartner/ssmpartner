...
const About = () => {
  ...
  return (
    <main>
      ...
      {/* Intro */}
      <section className="relative" style={{ marginTop: "-2.5rem", paddingTop: "5rem", paddingBottom: "5rem" }}>
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute inset-0" style={{ backgroundImage: `url(${ssmPattern})`, backgroundSize: "900px auto", backgroundPosition: "right top", backgroundRepeat: "repeat-y", opacity: 0.07, mixBlendMode: "multiply" }} />
        </div>
