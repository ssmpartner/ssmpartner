    ...
    <main>
      ...
      <section className="py-20 lg:py-28 relative">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-14 left-0 right-0 bottom-0" style={{ backgroundImage: `url(${ssmPattern})`, backgroundSize: "900px auto", backgroundPosition: "right top", backgroundRepeat: "repeat-y", opacity: 0.07, mixBlendMode: "multiply" }} />
        </div>
