                  ...
                  <div className="w-full aspect-square bg-muted rounded-2xl overflow-hidden relative">
                    ...
                    {member.badge && (
                      <span className="absolute bottom-2 left-2 font-body text-[10px] font-medium px-2 py-0.5 rounded-full text-white shadow-sm" style={{ backgroundColor: "#6A9387" }}>
                        {({ verkaufsleiter: "Verkaufsleiter", teamleiter: "Teamleiter", finanzexperte: "Finanzexperte", finanzcoach: "Finanzcoach", finanzcoach_in_ausbildung: "Finanzcoach in Ausbildung", finanzcoach_vbv: "Finanzcoach VBV", finanzcoach_ssm: "Finanzcoach SSM", vermoegensberater: "Vermögensberater", vermoegensberater_iaf: "Vermögensberater IAF", dipl_finanzberater_iaf: "Dipl. Finanzberater IAF", agenturleiter: "Agenturleiter", trainee: "Trainee" } as Record<string, string>)[member.badge] || member.badge}
                      </span>
                    )}
                  </div>
                  <h3 className="font-heading text-base font-semibold text-foreground mt-4">{member.name}</h3>
